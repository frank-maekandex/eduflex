<template>
  <div class="min-h-svh bg-white">
    <div class="flex flex-row mx-auto justify-between items-center gap-4 p-10 max-w-[1200px]">
        <div>
    ...
    <div class="grid lg:grid-cols-2 relative">
        <div class="flex flex-row items-start gap-4">
          <div class="flex flex-col gap-4 justify-center items-center mx-auto w-full mr-14">
            
            <Card class="flex flex-col shadow-none border-none bg-transparent w-full gap-1">
          ...
          <div class="border-l border-gray-border h-80"/>
        </div>
