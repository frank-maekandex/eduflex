<template>
  <div>
    <Card class="bg-primary text-white p-4 rounded-2xl border-none overflow-hidden flex flex-col items-start md:flex-row md:items-end justify-between gap-4">
      ...
      <div class="flex flex-col items-start md:items-end gap-2">
        <NuxtLink to="/dashboard/school/wallet/withdraw">
          <Button variant="outline" class="w-full">
            Withdraw to Verified Account
          </Button>
        </NuxtLink>
      </div>
    </Card>
