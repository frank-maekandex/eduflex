<template>
  <div class="relative w-full h-[550px] rounded-5xl overflow-hidden mt-2 mb-28">
    ...
    <!-- Overlay -->
    <div class="absolute inset-0 bg-gradient-to-r from-primary/95 via-secondary/80 to-primary/40 flex flex-col justify-center px-8 md:px-16">
      <h1 class="text-white text-3xl md:text-6xl font-bold mb-4">
